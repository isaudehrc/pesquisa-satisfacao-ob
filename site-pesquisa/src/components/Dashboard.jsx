...
export function Dashboard() {
  ...
  // 2. Prepara os dados para o Gráfico de Barras
  ...
  // 3. A NOVA MÁGICA: Inteligência de Idades
  const calcularIdade = (dataNascimento) => {
    ...
    // Ajuste fino: se ainda não fez aniversário no ano atual, tira 1 ano
  ...
  // Extrai apenas as idades válidas das fichas
  ...
  if (idadesValidas.length > 0) {
    ...
    // Descobre qual grupo tem o maior número de pessoas
    ...
    <div className="min-h-screen bg-gray-100 p-4 md:p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          ...
          {/* Card 3: Perfil de Público (O KPI Chique!) */}
